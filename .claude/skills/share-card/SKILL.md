...
**第二问 — 什么排版模式？**（自适应始终放第一个，最多 4 个选项）

| 选项 | 标签 | 说明 |
|------|------|------|
| A | 自适应 | AI 量身定制 |
| B | 浅色主题 | 森绿亮 / 玫瑰朝霞 / 简洁白 |
| C | 暗色主题 | 森绿暗 / 霓虹紫 / 暖咖 / 北极蓝灰 |

**第三问 — 选具体主题**（仅当第二问选了 B 或 C 时弹出）

选了 B 浅色主题时：

| 选项 | 标签 | 说明 |
|------|------|------|
| A | 森绿亮 | Everforest Light，米黄底 + 暖白卡片 |
| B | 玫瑰朝霞 | Rosé Pine Dawn，粉底 + 白卡片 |
| C | 简洁白 | GitHub，浅灰底 + 白卡片 |

选了 C 暗色主题时：

| 选项 | 标签 | 说明 |
|------|------|------|
| A | 森绿暗 | Everforest Dark，暗绿底 + 深绿卡片 |
| B | 霓虹紫 | Dracula，紫灰底 + 暗紫卡片 |
| C | 暖咖 | Gruvbox，暖棕底 + 深色卡片 |
| D | 北极蓝灰 | Nord，蓝灰底 + 暗卡片 |

**三项都确认后才开始生成。宽度固定 mobile 750px。**
